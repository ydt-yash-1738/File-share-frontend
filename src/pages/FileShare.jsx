...
function Share() {
  ...
  // New function to reset the component state instead of reloading the page
  const resetUpload = () => {
    setFile("");
    setResult("");
    setFileName("");
      ...
      <div className="bg-white rounded-lg p-8 shadow-lg bg-opacity-70 max-w-md w-full mx-4 flex flex-col items-center justify-center">
        ...
        {result && (
          <div className="flex flex-col items-center justify-center w-full mb-4">
            ...
            {/* Modified button to use resetUpload instead of page refresh */}
            <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg" onClick={resetUpload}>
              New Upload
            </button>
          </div>
        )}
